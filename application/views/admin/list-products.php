...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/admin/assets/css/summernote.css">
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row"> -->
                        ...
                        <!-- <div class="col-sm-12"> -->
                            <div class="card">
                                <div class="card-header">
                                    <h5 id="detail_name">Please select Category</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row product-page-main">
                                        <div class="col-xl-6" id="gallery">
                                    ...
                                    <div class="row product-page-main">
                                        <div class="col-sm-12" id="cat_desc">
                                        </div>
                                    </div>
                                    <div class="row product-page-main">
                                        <div class="col-sm-12" id="vat">
                                        </div>
                                        <div class="col-sm-12" id="art_work">
                                        </div>
                                    </div>
                                    <div class="row product-page-main">
                                        <div class="col-sm-12" id="cat_price">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?php echo base_url()?>assets/admin/assets/js/editor/summernote/summernote.js"></script>
    <script src="<?php echo base_url()?>assets/admin/assets/js/editor/summernote/summernote.custom.js"></script>
    <script>
        toastr.options = {
            closeButton: !0,
            progressBar: !0,
            ...
            timeOut: 4e3
        }, toastr.error("Please Select Category", "1").css(({
            width: "500px",
            "max-width": "500px"
        }));
        function get_card(id){
            $.ajax({
                ...
                success: function(res){
                    ...
                    $.ajax({
                        ...
                        success : function(res_price){
                            ...
                            $("#cat_price").jsGrid({
                                ...
                                controller: db,
                                fields: [
                                    { name: "Quantity", type: "text", width: "25%" },
                                    { name: "Saver", type: "text", width: "25%" ,editField :false},
                                    { name: "Standard", type: "text", width: "25%" },
                                    { name: "Express", type: "text", width: "25%"},
                    ...
                    // Vat
                    $("#vat")[0].innerHTML = "";
                    $("#art_work")[0].innerHTML = "";
                    if(quantity.length > 0){
                        $("#vat").append('<div class="form-group row">'+
                                            '<label class="col-sm-3 col-form-label">VAT(%)</label>'+
                                            '<div class="col-sm-7">'+
                                                '<input class="form-control" type="number" id="vat_val" value="'+quantity[0].vat+'">'+
                                            '</div>'+
                                            '<div class="col-sm-1">'+
                                                '<button class="btn btn-default btn-lg" id="vat_save" data-original-title="" title=""><span class="icon-save"></span></button>'+
                                            '</div>'+
                                        '</div>');
                        $("#art_work").append('<div class="form-group row">'+
                                            '<label class="col-sm-3 col-form-label">File Check(£)</label>'+
                                            '<div class="col-sm-7">'+
                                                '<input class="form-control" type="number" id="f_check" value="'+res[0].art1+'">'+
                                            '</div>'+
                                            '<div class="col-sm-1">'+
                                                '<button class="btn btn-default btn-lg" id="art_save" data-original-title="" title=""><span class="icon-save"></span></button>'+
                                            '</div>'+
                                        '</div>'+
                                        '<div class="form-group row">'+
                                            '<label class="col-sm-3 col-form-label">File Check with Proofing(£)</label>'+
                                            '<div class="col-sm-7">'+
                                                '<input class="form-control" type="number" id="f_proof" value="'+res[0].art2+'">'+
                                            '</div>'+
                                        '</div>'+'<div class="form-group row">'+
                                            '<label class="col-sm-3 col-form-label">File Assist(£)</label>'+
                                            '<div class="col-sm-7">'+
                                                '<input class="form-control" type="number" id="f_assist" value="'+res[0].art3+'">'+
                                            '</div>'+
                                        '</div>');
                    }
                    $("#art_save").click(function(){
                        $.ajax({
                            url : "<?php echo base_url()?>admin/save_art",
                            data : {
                                art1 : $("#f_check").val(),
                                art2 : $("#f_proof").val(),
                                art3 : $("#f_assist").val(),
                    ...
                    $("#vat_save").click(function(){
                        $.ajax({
                            url : "<?php echo base_url()?>admin/save_vat",
                            data : {
                                vat_val : $("#vat_val").val(),
                                pro_id : id
                            },

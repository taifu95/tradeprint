...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">All Products</a>
                                                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Cards & Stationary</a>
                                                <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Flyers & Leaflets</a>
                                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Booklets & Brochures</a>
                                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Signs & Posters</a>
                                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Display</a>
                                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Lables & Packaging</a>
                                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Promo & Clothing</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="name">INPUT NEW MENU</label>
                                        <input class="form-control" id="new_menu" type="text" placeholder="" required="required" data-original-title="" title="">
                                    </div>
                                    <div id='jqxWidget'>
                            ...
                            <div class="card b-r-0">
                                ...
                                <div class="card-body">
                                    <div class="form-group" style="float:right">
                                        <a class="btn btn-danger btn-lg" style="color:white;cursor:pointer" data-original-title="" title="" id="save"><span class="fa fa-save"></span> SAVE</a>
                                    </div>
                                    <div id="treeC"></div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                ...
                success : function(res){
                    ...
                    for(var i = 0; i < res.length ; i++){
                        var temp = {};
                        temp['label'] = res[i]["c_name"];
                        c_source.push(temp);
                    }
                    $('#treeC').jqxTree({ allowDrag: true, allowDrop: false, height: '900px', width: '100%', source: c_source,
            ...
            var source = [
                { label: "All Proudcts" },
                { label: "Cards & Stationery", expanded: true, },
                { label: "Flyers Leaflets" },
                { label: "Booklet & Brochures" },
                { label: "Signs @ Posters" },
                { label: "Display" },
                { label: "Labels & Packaging" },
                { label: "Promo & Clothing" }
            ];
            var source1 = [
            ...
            $('#treeA').jqxTree({ allowDrag: true, allowDrop: true, height: '300px', width: '100%', source: source,
                dragStart: function (item) {
                    if (item.label == "Community")
                        return false;
                },
            ...
            $('#treeB').jqxTree({ allowDrag: true, allowDrop: true, height: '300px', width: '100%' , source: source1,
                dragEnd: function (item, dropItem, args, dropPosition, tree) {
            ...
            $("#new_menu").on("keypress",function(e){
                if(e.keyCode == "13"){
                    console.log(source);
                    var temp = {};
                    temp['label'] = "dfdfd";
                    source.push(temp);
                    $('#treeA').jqxTree({source: source});
                }
            })
            $("#save").on("click",function(){
                // console.log($("#treeB").val());
                var menu = $("#treeB").jqxTree("getItems");
                console.log(menu);
                $.ajax({

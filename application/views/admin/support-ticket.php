...
<body>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Send Tickets</h5><span>We can send ticket to all users</span>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php 
                                            $total = json_decode($total_info,true);
                                        ?>
                                                ...
                                                <div class="bg-primary b-r-4 card-body">
                                                    <div class="media static-top-widget">
                                                        ...
                                                        <div class="media-body"><span class="m-0">Tickets</span>
                                                            <h4 class="mb-0 counter"><?php echo $total['ticket'][0]['total_ticket']?></h4><i class="icon-bg" data-feather="database"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card o-hidden">
                                                <div class="bg-secondary b-r-4 card-body">
                                                    <div class="media static-top-widget">
                                                        ...
                                                        <div class="media-body"><span class="m-0">Total Sent</span>
                                                            <h4 class="mb-0 counter"><?php echo $total['ticket'][0]['total_sent']?></h4><i class="icon-bg" data-feather="shopping-bag"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="bg-primary b-r-4 card-body">
                                                    <div class="media static-top-widget">
                                                        ...
                                                        <div class="media-body"><span class="m-0">Messages</span>
                                                            <h4 class="mb-0 counter"><?php echo $total['contact'][0]['total_contact']?></h4><i class="icon-bg" data-feather="message-circle"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card o-hidden">
                                                <div class="bg-primary b-r-4 card-body">
                                                    <div class="media static-top-widget">
                                                        ...
                                                        <div class="media-body"><span class="m-0">Current Users</span>
                                                            <h4 class="mb-0 counter"><?php echo $total['user'][0]['total_user']?></h4><i class="icon-bg" data-feather="user-plus"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12" style="box-shadow : 0 0 15px 10px #f7f7f7;padding:10px">
                                        <div class="form-group" style="float:right">
                                            <button class="btn btn-danger" id="send"><i class="fa fa-send"></i> Send Ticket</button>
                                        </div>
                                    ...
                                    <?php 
                                        $ticket_d = json_decode($ticket,true);
                                    ?>
                                    <div class="col-lg-12" style="border-top : 1px dashed #ddd;padding:20px 0px">
                                        <div class="table-responsive">
                                            <table class="display" id="basic-6">
                                                ...
                                                <tbody>
                                                    <?php for($i = 0; $i < count($ticket_d); $i++){
                                                    ?>
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <!-- <img class="rounded-circle img-30 mr-3" src="<?php echo base_url()?>assets/admin/assets/images/user/1.jpg" alt="Generic placeholder image"> -->
                                                                <!-- <i class="icon-write" aria-hidden="true"></i> -->
                                                                <div class="media-body align-self-center">
                                                                    <div><?php echo $ticket_d[$i]['subject']?></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <!-- <td><?php echo $ticket_d[$i]['content']?></td> -->
                                                        <td><?php echo $ticket_d[$i]['cre_date']?></td>
                                                        <td><?php echo $ticket_d[$i]['total_sent']?></td>
                                                        <!-- <td>
    ...
    <script>
        ...
        $("#send").click(function(){
            ...
            $.ajax({
                url : "<?php echo base_url()?>admin/send_ticket",
                data : {
                    content : content,
                    subject : $("#sub").val()
                },
                ...
                success : function(res){
                    if(res == "success"){
                        $("#sub").val("");
                        document.locattion = "<?php echo base_url()?>admin/ticket";

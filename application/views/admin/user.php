                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $user[$i]["ip_address"]?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="btn btn-success btn-sm" ><i class="fa fa-link" onclick="up_user()"></i> Update</a>
                                                            <a class="btn btn-danger btn-sm" onclick="del_user(<?php echo $user[$i]['id']?>)"><i class="fa fa-trash"></i> Delete</a>

...
<head>
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/admin/assets/css/calendar.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
...
<body>
    ...
    <!-- Plugins JS start-->
    <script src="<?php echo base_url()?>assets/admin/assets/js/jquery.ui.min.js"></script>
    <script src="<?php echo base_url()?>assets/admin/assets/js/calendar/moment.min.js"></script>
    <script src="<?php echo base_url()?>assets/admin/assets/js/calendar/fullcalendar.min.js"></script>
    <script src="<?php echo base_url()?>assets/admin/assets/js/calendar/fullcalendar-custom.js"></script>
